...
@section('content')
    <div class="ps-page--blog">
        <div class="ps-post--detail ps-post--parallax">
            <div class="ps-post__header bg--parallax" data-background="{{asset('frontend/img/bg/blog-detail.jpg')}}">
                <div class="container">
                    <h4>Technology</h4>
                    <h1>Harman Kadon Onyx Studio Mini, <br> Reviews & Experiences</h1>
            ...
            <div class="container">
                <div class="ps-post__content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 "><img class="mb-30" src="{{asset('frontend/img/blog/detail/2.jpg')}}" alt="">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 "><img class="mb-30" src="{{asset('frontend/img/blog/detail/3.jpg')}}" alt="">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 "><img class="mb-30" src="{{asset('frontend/img/blog/detail/4.jpg')}}" alt="">
                        </div>
                    </div>
                    ...
                    <p>Both of these assumptions, of course, could be entirely false. Self-censoring is firmly rooted in our experiences with mistakes in the past and not the present
    ...
    <div class="container">
        <div class="ps-block--author">
            <div class="ps-block__thumbnail"><img src="{{asset('frontend/img/users/1.png')}}" alt=""></div>
        ...
        <div class="ps-post-comments">
            ...
            <div class="ps-block--comment">
                <div class="ps-block__thumbnail"><img src="https://1.gravatar.com/avatar/af7935f33b10cec23f77b8d9717641df?s=70&amp;d=mm&amp;r=g" alt=""></div>
                <div class="ps-block__content">
            ...
            <div class="ps-block--comment">
                <div class="ps-block__thumbnail"><img src="https://2.gravatar.com/avatar/b2c1febfd11117eef66c351c1d4c10f1?s=70&amp;d=mm&amp;r=g" alt=""></div>
                <div class="ps-block__content">
                    ...
                    <div class="ps-block--comment">
                        <div class="ps-block__thumbnail"><img src="https://2.gravatar.com/avatar/25df3939b2e33bd19783411afd5bc6e3?s=70&amp;d=mm&amp;r=g" alt=""></div>
                        <div class="ps-block__content">
            ...
            <form class="ps-form--post-comment" action="http://nouthemes.net/html/martfury/do_action" method="post">
