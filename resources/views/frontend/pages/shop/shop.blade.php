...
{{--            <div class="ps-shop-brand"><a href="#"><img src="{{asset('frontend/img/brand/1.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/2.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/3.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/4.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/5.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/6.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/7.jpg')}}" alt=""></a><a href="#"><img src="{{asset('frontend/img/brand/8.jpg')}}" alt=""></a></div>--}}
            <div class="ps-shop-categories" style="padding: 20px 0px 0px 0px;">
                <div class="row align-content-lg-stretch">
                    @foreach($shops as $shop)
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category-2" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{url($shop->logo)}}" alt=""></div>
...
{{--                                </div>--}}
{{--                                <div class="ps-product">--}}
{{--                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/best/3.jpg')}}" alt=""></a>--}}
...
{{--                                </div>--}}
{{--                                <div class="ps-product">--}}
{{--                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/best/4.jpg')}}" alt=""></a>--}}
...
{{--                                </div>--}}
{{--                                <div class="ps-product">--}}
{{--                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/best/5.jpg')}}" alt=""></a>--}}
{{--                                        <ul class="ps-product__actions">--}}
{{--                                            <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon-bag2"></i></a></li>--}}
{{--                                            <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>--}}
{{--                                            <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>--}}
...
{{--                                </div>--}}
{{--                                <div class="ps-product">--}}
{{--                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/best/6.jpg')}}" alt=""></a>--}}
...
{{--                                </div>--}}
{{--                                <div class="ps-product">--}}
{{--                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/best/7.jpg')}}" alt=""></a>--}}
{{--                                        <ul class="ps-product__actions">--}}
{{--                                            <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon-bag2"></i></a></li>--}}
{{--                                            <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>--}}
{{--                                            <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>--}}
