    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-danger navbar-badge">{{$new_orders + $new_seller + $new_customer }}</span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <span class="dropdown-item dropdown-header">{{$new_orders + $new_seller + $new_customer}} Notifications</span>
               @if($new_orders >0)
                <div class="dropdown-divider"></div>
                ...
                <a href="{{route('admin.review.index')}}" class="dropdown-item">
                    <i class="fas fa-street-view mr-2"></i> {{$new_reviews}} new Review
                    <span class="float-right text-muted text-sm">2 days</span>
                </a>
                @endif
{{--                <div class="dropdown-divider"></div>--}}
